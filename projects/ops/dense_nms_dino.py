...
from .nms_dino import DINOWithNMS, Branch
...
class DDQDINOWithNMSAlign(DINOWithNMS):
    def __init__(
        self,
        *args,
    ...
    def _init_layers(self) -> None:
        ...
        super(DINOWithNMS, self)._init_layers()
...
@MODELS.register_module()
class DDQDETRHeadWithNMS(DDQDETRHead):
    def __init__(
        self,
        *args,
...
@MODELS.register_module()
class DDQDINOWithNMSAlignWithKV(DDQDINOWithNMSAlign):
